...
const BvnWithoutWithImage: React.FC = (props: Props) => {
    const { } = props;
        ...
        <>
            ...
            <section className="bg-white mt-8 garrif rounded-md">
                <div className="flex items-center px-3 md:px-5 py-4 rounded-lg bg-softpassgray-50 md:bg-transparent">
                    <h1 className="w-6/12 text-[22px] font-semibold">Bluk BVN with/without image</h1>
...
export default BvnWithoutWithImage;
