...
function VerificationIcon(props: Props) {
    ...
    return (
        ...
        <path d="M16.5 9H7.5C7.22 9 7 8.78 7 8.5V6.5C7 5.67 7.67 5 8.5 5H15.5C16.33 5 17 5.67 17 6.5V8.5C17 8.78 16.78 9 16.5 9Z" fill="#292D32"/>
        <path d="M16.5 15H7.5C7.22 15 7 15.22 7 15.5V17.5C7 18.33 7.67 19 8.5 19H15.5C16.32 19 17 18.33 17 17.5V15.5C17 15.22 16.78 15 16.5 15Z" fill="#292D32"/>
        </svg> 
    )
}
